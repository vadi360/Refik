# AvukatPro — Master Ürün & Teknik Plan v2.1
...
| **UETS/PTT** | Resmi API yok | 🟡 Orta | WebView + otomasyon (5 gün kuralı ile) |
...
5. Yeni tebligat varsa bildirim gider
6. 5 günden eski tebligatlar otomatik indirilir
...
## v2.2 Değişiklik Özeti (v2.1'den fark)

| Değişiklik | Açıklama |
|------------|----------|
| Büyüme stratejisi | "Organik + pazarlama" eklendi |
| İstatistik varsayımı | "%80" kaldırıldı, "önemli bir kısım" yapıldı |
| OTP doğrulama | Baro entegrasyonu yok, telefon OTP yeterli |
| UETS 5 gün + okundu kuralı | Hem okundu hem 5 gün kombinasyonu eklendi |
| e-imza gelecek plan | Faz 4 icra otomasyonu için altyapı planı eklendi |
| Admin panel | Teknik mimariye eklendi |
| Tam kapsam vurgusu | Web + Mobile + Eklenti + Backend + Admin hepsi başta belirtildi |
| Süre hesaplama | "Açılma tarihi + X gün" formatında örnek tablo eklendi |
